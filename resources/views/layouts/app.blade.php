...
<body>
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('account.track-order') }}">Transactions History</a>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('products.cart') }}" class="nav-link" data-toggle="" aria-haspopup="true" aria-expanded="false">
                                    <i class="fa fa-shopping-basket"></i> <span class="badge badge-primary d-none">5</span>
                                </a>
    ...
    <footer>
        ...
        <p class="copyright">&copy; 2024 Muhammad Gamal Zayan | Groceries Organic Store. All rights reserved.</p>
    </footer>
