        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <form method="POST" action="{{ route('products.add.cart') }}">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <input class="form-control" name="qty" type="number" min="1" data-bts-button-down-class="btn btn-primary" data-bts-button-up-class="btn btn-primary" value="1" name="vertical-spin">
                        </div>
                    ...
                    @if(isset(Auth::user()->id))
                        @if($checkInCart > 0)
                        <button class="mt-3 btn btn-primary btn-lg" disabled>
                    ...
                    <div class="item">
                        <div class="card card-product">
                            ...
                            <div class="card-badge">
                                ...
                                <img src="{{ asset('assets/img/' . $related->image . '') }}" alt="Card image 2" class="card-img-top">
                            </div>
                            <div class="card-body">
                                <h4 class="card-title">
                                    <a href="{{ route('single.product', $related->id) }}">{{ $related->name }}</a>
                                </h4>
                                <div class="card-price">
                                    <!-- <span class="discount">Rp. 300.000</span> -->
                                    <span class="reguler">{{ $related->price }} EGP</span>
                                </div>
                                <a href="{{ route('single.product', $related->id) }}" class="btn btn-block btn-primary">
                                    View Product
                                </a>
