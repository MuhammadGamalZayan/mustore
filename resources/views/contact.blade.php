            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-5">
                    <div class="detail-wrapper p-5 bg-primary">
                        ...
                        <p class="text-light">
                            <a href="https://wa.me/+201030303532" class="text-white"><i class="fas fa-phone"></i> +201030303532<br></a>
                            <i class="fas fa-envelope"></i> muhammadgamalzayan@gmail.com
                        </p>
                    </div>
                </div>
            </div>
